...
import ResercherLeadTableRow from './ResercherLeadTableRow.jsx';
...
const ResercherLeadTable = ({ header }) => {
                ...
                <table className='w-full overflow-auto text-left'>
                    ...
                    <tbody>
                        {currentPageData.map((researcher, index) => (
                            <ResercherLeadTableRow key={index} {...researcher} />
                        ))}
                    </tbody>
                </table>
...
export default ResercherLeadTable;
