...
export default function CurrentGroupMembers({ myMembers }) {
  // Check if myMembers and team are defined
        ...
        <div className="grid md:grid-cols-2 grid-col-1 md:gap-10">
          <div>
            ...
            <section className='flex gap-2 my-5 items-center px-2 font-Satoshi-Black'>
              ...
              <div className='py-5'>
                <p className='text-[1rem] font-bold'>{owner.fullname}</p>
                <p className='text-light text-sm'>{owner.workemail}</p>
              </div>
            </section>
          ...
          <div>
            ...
            <section className='flex gap-2 my-5 items-center px-2 font-Satoshi-Black'>
              ...
              <div className='py-5'>
                <p className='text-[1rem] font-bold'>Select Supervisor</p>
