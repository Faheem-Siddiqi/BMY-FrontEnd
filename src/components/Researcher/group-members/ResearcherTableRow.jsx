...
const ResearcherTableRow = ({ profileImage, name, email, institution, designation }) => {
  return (
    <tr className='w-full'>
      <td className='px-4'>
      ...
      <td className='px-4'>
        <div className='flex gap-2'>
          <button className='bg-epsilon text-white rounded px-1'>Accept</button>
          <button className='bg-red-500 text-white rounded px-1'>Decline</button>
          <button className='bg-stone-400 text-white rounded px-3'>Sent</button>
          <button className='px-3'>Already Member</button>
        </div>
      </td>
    </tr>
  );
