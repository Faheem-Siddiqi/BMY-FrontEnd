        ...
        <div className="w-full max-w-4xl p-5 md:p-20 shadow-sm bg-iota rounded-box">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div>
              ...
              <div className=" mb-4 text-primary">
                <div className=" flex items-center gap-2 mb-4">
                  ...
                  >
                    <path
                      d="M6.99944 14.5C6.56292 14.5007 6.13181 14.5966 5.73618 14.781C5.34055 14.9655 4.98995 15.234 4.70883 15.568C4.42772 15.9019 4.22286 16.2932 4.10857 16.7145C3.99427 17.1358 3.97329 17.5769 4.04709 18.0072C4.12088 18.4374 4.28768 18.8463 4.53583 19.2055C4.78399 19.5646 5.10752 19.8652 5.48386 20.0864C5.86019 20.3076 6.28026 20.444 6.71474 20.486C7.14923 20.5281 7.58766 20.4749 7.99944 20.33"
                      stroke="#337E31"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  >
                    <path
                      d="M18.875 9.6875H19.1112C19.6607 10.8495 19.9688 12.1472 19.9688 13.5156C19.9688 18.4696 15.9384 22.5 10.9844 22.5C6.03039 22.5 2 18.4696 2 13.5156C2 8.56164 6.03039 4.53125 10.9844 4.53125C12.3528 4.53125 13.6505 4.8393 14.8125 5.38883V5.625V6.37297L14.1891 6.99633C13.2219 6.51883 12.134 6.25 10.9844 6.25C6.97813 6.25 3.71875 9.50938 3.71875 13.5156C3.71875 17.5219 6.97813 20.7812 10.9844 20.7812C14.9906 20.7812 18.25 17.5219 18.25 13.5156C18.25 12.3659 17.9812 11.278 17.5037 10.3108L18.127 9.6875H18.875ZM14.6562 13.5156C14.6562 15.5403 13.0091 17.1875 10.9844 17.1875C8.95969 17.1875 7.3125 15.5403 7.3125 13.5156C7.3125 11.4909 8.95969 9.84375 10.9844 9.84375C11.0994 9.84375 11.213 9.84977 11.3252 9.86016L12.7589 8.42648C12.2028 8.23203 11.606 8.125 10.9844 8.125C8.01195 8.125 5.59375 10.5432 5.59375 13.5156C5.59375 16.488 8.01195 18.9062 10.9844 18.9062C13.9568 18.9062 16.375 16.488 16.375 13.5156C16.375 12.894 16.268 12.2972 16.0735 11.7411L14.6399 13.1747C14.6502 13.287 14.6562 13.4006 14.6562 13.5156ZM18.875 8.125L22 5H19.5V2.5L16.375 5.625V7.02008L11.5762 11.8189C11.3908 11.7542 11.1918 11.7187 10.9844 11.7187C9.99195 11.7187 9.1875 12.5231 9.1875 13.5155C9.1875 14.508 9.99195 15.3124 10.9844 15.3124C11.9768 15.3124 12.7812 14.508 12.7812 13.5155C12.7812 13.3081 12.7457 13.1091 12.681 12.9237L17.4799 8.125H18.875Z"
                      fill="#337E31"
                    />
                  </svg>
                  <p> Succeed</p>
            ...
            <div className="md:p-10 p-5 bg-white rounded-r-lg">
              <h2 className="text-3xl font-bold  font-WorkSans-Regular">
                Sign Up
              </h2>
              ...
              <div className=" text-sm text-inputFields">
                <section className="mb-4 font-NunitoSans-Regular ">
                  <label htmlFor="email">Full Name</label>
                  <span className="text-xs text-red-600">
                    {!name && requiredError && " * Required"}
                  </span>
                  <input
                    name="name"
                    id="name"
