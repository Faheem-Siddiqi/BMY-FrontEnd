        ...
        <>
            <>
                <div className="h-screen w-screen bg-gray-100 flex items-center">
                    <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-green-00">
                        <div className="max-w-md">
                            <div className="text-5xl font-dark font-bold">403
                               
                            </div>
                             <div className="text-2xl my-2 font-dark font-semibold">
                             Unauthorized Access
                            </div>
                            ...
                            <button
                                ...
                                className="px-7 py-3 rounded-md group relative overflow-hidden  bg-epsilon  text-white transition-all duration-300 ease-out hover:bg-gradient-to-r hover:from-epsilon hover:to-epsilon ">
